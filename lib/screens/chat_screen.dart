...
class _ChatScreenState extends State<ChatScreen> {
  ...
  String? _actualChatRoomId; // Nullable to properly track initialization
  ...
  Future<void> _makeCall() async {
    try {
      // Fetch caregiver data to get phone number
      final caregiver = await _firestoreService.getUserById(widget.caregiverId);
      
      if (caregiver == null || caregiver.phone == null || caregiver.phone!.isEmpty) {
        if (mounted) {
  ...
  Future<void> _sendMessage() async {
    ...
    if (_actualChatRoomId == null || _actualChatRoomId!.isEmpty) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              if (_messageController.text.trim().isNotEmpty && _actualChatRoomId != null) {
                try {
