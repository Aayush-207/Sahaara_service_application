  ...
  Future<void> seedCaregivers() async {
    ...
    final caregivers = [
      ...
      UserModel(
        ...
        services: ['Dog Walking', 'Pet Sitting', 'Dog Transportation'],
        hourlyRate: null,
      ...
      UserModel(
        ...
        services: ['Grooming', 'Dog Training', 'Pet Sitting'],
        hourlyRate: null,
      ...
      UserModel(
        ...
        services: ['Vet Visit Companion', 'Pet Sitting', 'Dog Walking'],
        hourlyRate: null,
      ...
      UserModel(
        ...
        services: ['Dog Training', 'Pet Sitting', 'Dog Walking'],
        hourlyRate: null,
      ...
      UserModel(
        ...
        services: ['Dog Walking', 'Dog Transportation', 'Pet Sitting'],
        hourlyRate: null,
      ...
      UserModel(
        ...
        services: ['Pet Sitting', 'Grooming', 'Dog Transportation'],
        hourlyRate: null,
